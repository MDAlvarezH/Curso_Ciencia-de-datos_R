...
b.d$m1 # Seleccionar la columna de matrícula total
...
b.d[b.d$yr==2007, ] # Selección de observaciones para las cuales yr == 2007
b.d[, c("yr", "acronimo", "s2")] # Selección de tres columnas
b.d[b.d$yr==2007, c("yr", "acronimo", "s2")] # Selección tres columnas para yr == 2007
...
filter(cemabe_df, MUN %in% c(2, 7, 10)) # Mpos. con estas claves
...
foo <- select(cemabe_df, NOM_MUN, P166, P167, P313)
